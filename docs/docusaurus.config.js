...
const config = {
  ...
  projectName: "antik", // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: "https://github.com/webinex/antik/tree/main/docs/",
        },
        theme: {
    ...
    ({
      ...
      navbar: {
        ...
        logo: {
          alt: "Webinex Logo",
          src: "img/logo.svg",
          href: "/antik/docs/getting-started",
        },
        items: [
          {
            type: "docSidebar",
          ...
          {
            href: "https://github.com/webinex/antik",
            label: "GitHub",
            position: "right",
          },
        ],
