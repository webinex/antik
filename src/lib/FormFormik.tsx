...
interface Extension<T> {
  uid: string;
  children: React.ReactNode | undefined | ((formik: FormikContextType<T>) => ReactElement);
  ns?: string;
}
...
const FormFormikComponent = memo(<T extends FormikValues,>(props: FormFormikProps<T>) => {
  props = Object.assign({}, FormFormik.defaults, props);
...
}) as (<T extends FormikValues>(props: FormFormikProps<T>) => ReactElement | null) & {
  displayName?: string;
};

FormFormikComponent.displayName = 'Form.Formik';

export const FormFormik = /* @__PURE__ */ Object.assign(FormFormikComponent, {
  defaults: {} as Partial<FormFormikProps<any>>,
});
