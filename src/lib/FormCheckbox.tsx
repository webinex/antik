...
const FormCheckboxComponent = memo((props: FormCheckboxProps) => {
  props = Object.assign({}, FormCheckbox.defaults, props);
...
const DEFAULTS: Pick<FormCheckboxProps, 'mapGet' | 'mapSet'> = {
  mapSet: (e) => e.target.checked,
  mapGet: ([{ value }]) => !!value,
};

FormCheckboxComponent.displayName = 'Form.Checkbox';

export const FormCheckbox = /* @__PURE__ */ Object.assign(FormCheckboxComponent, {
  defaults: DEFAULTS,
});
