...
function isKeyError(x: any): x is { key: string } {
  return typeof x === 'object' && Object.prototype.hasOwnProperty.call(x, 'key') && x['key'] != null;
}
...
const FormErrorMessageComponent = memo((props: FormErrorMessageProps) => {
  props = Object.assign({}, FormErrorMessage.defaults, props);
...
FormErrorMessageComponent.displayName = 'Form.ErrorMessage';

export const FormErrorMessage = /* @__PURE__ */ Object.assign(FormErrorMessageComponent, {
  defaults: {} as Partial<FormErrorMessageProps>,
});
