...
const FormSubmitComponent = memo((props: FormSubmitProps) => {
  props = Object.assign({}, FormSubmit.defaults, props);
...
FormSubmitComponent.displayName = 'Form.Submit';

export const FormSubmit = /* @__PURE__ */ Object.assign(FormSubmitComponent, {
  defaults: {} as Partial<FormSubmitProps>,
});
