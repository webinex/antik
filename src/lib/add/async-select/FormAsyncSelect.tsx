...
import type { FormExtensions } from '../../Form';
...
const FormAsyncSelectComponent = memo(
  <ValueType, OptionType extends Option>(props: FormAsyncSelectProps<ValueType, OptionType>) => {
    props = Object.assign({}, FormAsyncSelect.defaults, props);
    ...
    return (
      <FormSelect<ValueType, OptionType> {...asyncSelect} {...selectProps} {...mapGetAndSet} showSearch />
    );
  },
) as (<ValueType, OptionType extends Option>(
  props: FormAsyncSelectProps<ValueType, OptionType>,
) => ReactElement | null) & {
  displayName?: string;
};

FormAsyncSelectComponent.displayName = 'Form.AsyncSelect';

export const FormAsyncSelect = /* @__PURE__ */ Object.assign(fc(FormAsyncSelectComponent), {
  defaults: {} as Partial<FormAsyncSelectProps<any, Option>>,
});
...
function useMapGetAndSet<ValueType, OptionType extends Option>(
  ...
  return useMemo((): Partial<Pick<FormSelectProps<ValueType, Option>, 'mapGet' | 'mapSet'>> => {
    const mapGet = mapGetProp ?? FormSelect.defaults.mapGet!;
    const mapSet = mapSetProp ?? FormSelect.defaults.mapSet!;
