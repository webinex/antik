...
export interface FormAutoSubmitProps<TFormValue extends object = any> {
   ...
   * @default false (configurable via Form.AutoSubmit.DEFAULT_PROPS.pristine)
   */
  pristine?: boolean;
   ...
   * @default undefined shallow comparison (configurable via Form.AutoSubmit.DEFAULT_PROPS.compare)
   */
  compare?: (prevValues: TFormValue, currentValues: TFormValue) => boolean;
}

const FormAutoSubmitComponent = <TFormValue extends object = any>(props: FormAutoSubmitProps<TFormValue>) => {
  const { pristine, compare } = Object.assign({}, FormAutoSubmit.DEFAULT_PROPS, props);
...
export const FormAutoSubmit = Object.assign(FormAutoSubmitComponent, {
  DEFAULT_PROPS: {
    pristine: true,
